...
class Books:
    def _init_(self, name, rating, genre, author): #__init__ not _init_ need one more underscore on each side
        self.name = name
        self.rating = rating
        self.genre = genre
        self.author = author
...
for eachBook in bookArray:
    print(eachBook.name()) #you don't need parenthsis at the end of name only to specify eachBook.name